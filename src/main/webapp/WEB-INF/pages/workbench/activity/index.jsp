...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#createActivityBtn").click(function () {
			//初始化，当用户点击”创建“按钮时，重置表单；通过获取form表单的dom对象来实现
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <input class="form-control myDate" type="text" id="startTime" readonly id="query-startDate">
				    </div>
				  </div>
				  <div class="form-group">
				    <div class="input-group">
				      <div class="input-group-addon">结束日期</div>
					  <input class="form-control myDate" type="text" id="endTime" readonly id="query-endDate">
				    </div>
				  </div>
